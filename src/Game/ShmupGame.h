...
public:
	...
	static const float WORLD_UPPER_BOUND_X;
	static const float WORLD_LOWER_BOUND_X;
	static const float WORLD_UPPER_BOUND_Y;
	static const float WORLD_LOWER_BOUND_Y;
