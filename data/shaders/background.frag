...
void main()
{
    ...
    finalCol=tunneliter(uv,vec4(1.0,1.0,1.0,1.0),0.5+(xa*0.80),0.5+(ya*0.80),0.5,0.2,vec4(1.0,1.0,1.0,1.0),3.1);
    ...
    fragColor = vec4(vec3(finalCol.xyz),10000.0)*vec4(1.0, 0.0, 0.0, 1.0);
